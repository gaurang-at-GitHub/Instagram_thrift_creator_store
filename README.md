...
Here is the code that i wrote - I am pasting it as it is. First i wrote the commented things that helped me to understand which  entitites are all required and the field types as well as field properties vague overview. I am sharing what i wrote in one go and thinking out loud.
